...
test('invalid image candidate strings do not validate', function() {
  ...
  var s2 = new SrcsetInfo('pear-mobile.jpeg 7.2w, pear-tablet.jpeg 1280w');
...
test('single image declarations parse correctly', function() {
  var s1 = new SrcsetInfo('pear-mobile.jpeg 720w');
  var img = s1.imageCandidates[0];
...
test('multiple image candidates parse correctly', function() {
  var s1 = new SrcsetInfo('pear-mobile.jpeg 720w, pear-tablet.jpeg 1280w, pear-desktop.jpeg 1.5x');
...
test('repeated values for image candidates are ignored', function() {
  var s1 = new SrcsetInfo('pear-mobile.jpeg 720w, pear-tablet.jpeg 720w');
...
test('simple srcset picks correct image candidate', function() {
  ...
  mobile.setForTesting({w: 2000, h: 1000, x: 1});
  var s1 = new SrcsetInfo('banner-HD.jpeg 2x');
  var img = mobile.getBestImage(s1);
  equal(img.src, 'banner-HD.jpeg', 'picked only available image');
});

test('ambiguous srcset picks best image candidate', function() {
  var vp = new ViewportInfo();
  vp.setForTesting({w: 500, h: 500});
  var s1 = new SrcsetInfo('banner-wide.jpeg 300w 1000h, banner-tall.jpeg 1000w 300h, banner.jpeg');
...
test('complex srcset picks best image candidate', function() {
  ...
  var s1 = new SrcsetInfo('banner-HD.jpeg 2x, banner-phone.jpeg 400w, banner-phone-HD.jpeg 400w 2x');
  var img = mobile.getBestImage(s1);
